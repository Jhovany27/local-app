...
<body>
    <div class="app">
        ...
        <div class="body">
            ...
            <div style="display:flex;align-items:center;gap:.65rem;background:#fffbeb;border:1.5px solid #fbbf24;border-radius:10px;padding:.65rem .9rem;margin-top:.75rem;">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#d97706" style="width:18px;height:18px;flex-shrink:0;">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                </svg>
                <div>
                    <p style="font-size:.72rem;color:#92400e;line-height:1.3;">Pagas a la tienda al recoger</p>
                    <p style="font-size:.95rem;font-weight:900;color:#78350f;">${{ number_format($montoParaTienda, 2) }}</p>
                </div>
            </div>
            @endif
        ...
        <div id="modal-aceptar"
            ...
            <div
                ...
                <p style="font-size:0.82rem;color:#888;text-align:center;line-height:1.6;margin-bottom:1.5rem;">
                    @if($esEfectivo && $montoParaTienda !== null)
                        Ten disponibles <strong>${{ number_format($montoParaTienda, 2) }}</strong> en efectivo para pagarle a la tienda al recoger el pedido.
                    @else
